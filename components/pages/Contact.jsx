...
const Contact = () => {
  ...
  return (
    <section
      id="contactus"
      className="container-padding bg-primary-blue py-[140px]"
    >
      ...
      <div className=" bg-white rounded-[5px] p-[10px] grid grid-cols-1 lg:grid-cols-[40%_60%]">
        <div className="bg-primary-blue rounded-[5px] p-5 lg:p-10 text-white flex flex-col gap-10 md:gap-20 bg-[url(/images/landing/92-image-for-contact-us-section.svg)] bg-no-repeat bg-bottom-right">
          <div className="font-poppins text-left">
            <h5 className="2xl:text-28 xl:text-24 md:text-22 text-20 font-semibold">
              Contact Information
            </h5>
        ...
        <div className="p-2 sm:p-5 lg:p-10">
          ...
          >
            ...
            <div>
              <h6 className="font-poppins font-semibold text-14 text-black mb-3">
                Select Subject?
              </h6>
            ...
            <div>
              <div>
                <label className="text-12 font-poppins font-medium">
                  Message
                </label>
                <textarea
                  placeholder="Write your message.."
                  className="placeholder:text-gray-8080 border-b border-b-gray-8080 font-poppins font-medium text-14 p-2 resize-none"
                ></textarea>
              </div>
              <button
