...
const HeroSectionV5 = () => {
  ...
  return (
    <section className="h-screen flex flex-col relative">
      ...
      >
        <path
          d="M49.73 0.5H311.5V59.5H0.34C7.72 58.02 12.68 54.97 16.12 50.95C21.03 45.21 22.75 37.58 24.11 30.09C25.47 22.54 26.47 15.16 29.84 9.64C31.51 6.89 33.76 4.62 36.94 3.03C40.12 1.43 44.26 0.5 49.73 0.5Z"
          fill="white"
          stroke="white"
        />
      </svg>
